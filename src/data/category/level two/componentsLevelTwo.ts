export const componentsLevelTwo = [
  ...
  { name: "Gabinetes", categoryId: "cases", parentCategoryId: "components", level: 2 },
  { name: "Sistemas de Enfriamiento", categoryId: "cooling", parentCategoryId: "components", level: 2 }
];
