export const storageLevelTwo = [
  ...
  { name: "Unidades Ópticas", categoryId: "optical_drives", parentCategoryId: "storage", level: 2 },
  { name: "Caddies y Adaptadores", categoryId: "caddies_adapters", parentCategoryId: "storage", level: 2 }
];
