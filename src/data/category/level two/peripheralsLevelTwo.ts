export const peripheralsLevelTwo = [
  ...
  { name: "Webcams", categoryId: "webcams", parentCategoryId: "peripherals", level: 2 },
  { name: "Parlantes", categoryId: "speakers", parentCategoryId: "peripherals", level: 2 }
];